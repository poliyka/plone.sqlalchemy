...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_alchemy_test_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='alchemy-test'
        )
        self.assertTrue(view.__name__ == 'alchemy-test')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in alchemy-test'
        # )

    def test_alchemy_test_not_matching_interface(self):
